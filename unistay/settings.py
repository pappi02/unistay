"""
Django settings for unistay project.
...
SECRET_KEY = 'django-insecure-a4)_ie7a%4g1-#d_kaik9nm32@@r@kyhhgr-13@fozc&z*4-2w'
...
EMAIL_HOST_PASSWORD = 'uglkqipgixrejusd'  # Use environment variables for security
